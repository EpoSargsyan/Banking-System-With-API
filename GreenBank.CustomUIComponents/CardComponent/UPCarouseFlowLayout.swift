...
open class UPCarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    @IBInspectable open var sideItemShift: CGFloat = 1
    open var spacingMode = UPCarouselFlowLayoutSpacingMode.overlap(visibleOffset: 20) // Adjust this value for the partially visible effect
