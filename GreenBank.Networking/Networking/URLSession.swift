...
public extension URLSession {
    @discardableResult
    func execute<T: Codable>(with configuration: URLSessionConfiguration, dataType: T.Type) async throws -> T? {
        
        do {
            let request = try HTTPNetworkRequest.makeHTTPRequest(from: configuration.url,
